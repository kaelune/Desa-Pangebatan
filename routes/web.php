...
use App\Http\Controllers\Admin\AdminProfileDesaController;
use App\Http\Controllers\Front\FaqController;

/* Front End */
Route::get('/', [HomeController::class, 'index'])->name('home');
Route::get('/about', [AboutController::class, 'index'])->name('about');
Route::get('/aparatur', [AboutController::class, 'aparatur'])->name('aparatur');
Route::get('/aparatur/{id}', [AboutController::class, 'aparatur_detail'])->name('aparatur_detail');
...
// Profile Desa
Route::get('/admin/profile/show', [AdminProfileDesaController::class, 'index'])->name('admin_page_profile')->middleware('admin:admin');
Route::get('/admin/profile/add', [AdminProfileDesaController::class, 'add'])->name('admin_profile_add')->middleware('admin:admin');
Route::post('/admin/profile/store', [AdminProfileDesaController::class, 'store'])->name('admin_profile_store')->middleware('admin:admin');
Route::get('/admin/profile/edit/{id}', [AdminProfileDesaController::class, 'edit'])->name('admin_profile_edit')->middleware('admin:admin');
Route::post('/admin/profile/update/{id}', [AdminProfileDesaController::class, 'update'])->name('admin_profile_update')->middleware('admin:admin');
Route::get('/admin/profile/delete/{id}', [AdminProfileDesaController::class, 'delete'])->name('admin_profile_delete')->middleware('admin:admin');
...
Route::get('/home-banner-image', [AdminHomePageController::class, 'HomeBannerImage'])
->name('home_banner_image_show');
Route::get('/home-banner-image/add', [AdminHomePageController::class, 'HomeBannerImageAdd'])
->name('home_banner_image_add');
Route::post('/home-banner-image/store', [AdminHomePageController::class, 'HomeBannerImageStore'])
->name('home_banner_image_store');
Route::get('/home-banner-image/edit/{id}', [AdminHomePageController::class, 'HomeBannerImageEdit'])
->name('home_banner_image_edit');
Route::post('/home-banner-image/update/{id}', [AdminHomePageController::class, 'HomeBannerImageUpdate'])
->name('home_banner_image_update');
Route::get('/home-banner-image/delete/{id}', [AdminHomePageController::class, 'HomeBannerImageDelete'])
->name('home_banner_image_delete');
...
//<------ FAQ ------>
Route::get('/admin/home-faq', [AdminFaqController::class, 'index'])
->name('admin_home_faq');
...
//Tambahan Receive Email
Route::get('/admin/receive-email/show', [AdminPageController::class, 'receive_email'])->name('admin_receive_email')->middleware('admin:admin');
Route::get('/admin/receive-email/delete/{id}', [AdminPageController::class, 'receive_email_delete'])->name('receive_email_delete')->middleware('admin:admin');