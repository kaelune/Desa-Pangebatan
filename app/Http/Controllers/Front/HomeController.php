...
class HomeController extends Controller
{
    public function index() 
    {
        ...
        return view('front.home', compact('page_data','banner_image','left_skills','right_skills','education','experiences','testimonials','clients','services','portfolios','portfolio_categories','posts'));
    }
}
