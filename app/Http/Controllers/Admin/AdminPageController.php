...
class AdminPageController extends Controller
{
    ...
    public function about_update(Request $request)
    {
        ...
        $page_data->about_history = $request->about_history;
        $page_data->about_vision = $request->about_vision;
        $page_data->about_mission = $request->about_mission;
    ...
    {
        $all_data = ReceiveMessage::get();
        return view('admin.receive_email_show', compact('all_data'));
    }
    public function receive_email_delete($id)
    {
        $delete_data = ReceiveMessage::where('id', $id)->first();
        $delete_data->delete();
        return redirect()->route('admin_receive_email')->with('success', 'Pesan berhasil di hapus');
    }
}
