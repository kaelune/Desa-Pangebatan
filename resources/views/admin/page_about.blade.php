                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div class="mb-4">
                                    ...
                                    <textarea name="about_history" class="form-control editor" cols="30" rows="10">{{ $page_data->about_history }}</textarea>
                                </div>
                                <div class="mb-4">
                                    <label class="form-label">Visi*</label>
                                    <textarea name="about_vision" class="form-control editor" cols="30" rows="10">{{ $page_data->about_vision }}</textarea>
                                </div>
                                <div class="mb-4">
                                    <label class="form-label">Misi *</label>
                                    <textarea name="about_mission" class="form-control editor" cols="30" rows="10">{{ $page_data->about_mission }}</textarea>
                                </div>
                                <div class="mb-4">
                                    ...
                                    <div>
                                        ...
                                        @else
                                        <img id="showImage" src="{{ asset('uploads/'.$page_data->about_photo) }}" alt="" class="w_200"><br>
                                ...
                                <div class="mb-4">
                                    ...
                                    <div><input id="image" type="file" name="about_photo"></div>
                                </div>
                                <div class="mb-4">
                                    <label class="form-label">Existing Banner</label>
                                    <div>
                                        <img id="showImage1" src="{{ asset('uploads/'.$page_data->about_banner) }}" alt="" class="w_200">
                                    </div>
                                </div>
                                <div class="mb-4">
                                    <label class="form-label">Change Banner</label>
                                    <div><input id="image1" type="file" name="about_banner"></div>
                                </div>
                                <div class="mb-4">
