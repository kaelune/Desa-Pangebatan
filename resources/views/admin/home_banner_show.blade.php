                        ...
                        <div class="row">
                            ...
                            <div class="col-md-9">
                                ...
                                <div class="mb-4">
                                    ...
                                    <input type="text" class="form-control" name="banner_name" value="{{ $page_data->banner_name }}">
                                </div>
                                <div class="mb-4">
                                    <label class="form-label">Designation</label>
                                    <input type="text" class="form-control" name="banner_designation" value="{{ $page_data->banner_designation }}">
                                </div>
                                <div class="mb-4">
