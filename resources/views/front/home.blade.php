  ...
  <div >
    <div id="carouselExampleCaptions" class="carousel slide" data-bs-ride="carousel">
        <div class="carousel-inner">     
            ...
            @foreach($banner_image as $index => $item)
            ...
            <div class="container text-white">
                <p>{{ $page_data->banner_title }}</p>
                
                <h2 >Desa <span>{{ $page_data->banner_name }}</span></h2>  
                <p>{!! $page_data->banner_description !!}</p>              
                <div class="button">
                   <a href="{{ $page_data->banner_button_url }}" style="" class="btn btn-primary">{{ $page_data->banner_button_text }}</a>
                </div>                  
            </div>
        </div>
...
<div class="home-qualification">
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-6">
                <h2 class="title"><i class="fas fa-hand-holding-heart"></i> {{ $page_data->education_title }}</h2>
                <div class="inner">
